...
Please don't edit files under the migrations folder, those are auto-generated by alembic.


Project will be deployed using docker on ghcr.io, built with github actions and the Dockerfile is in ./docker/Dockerfile
